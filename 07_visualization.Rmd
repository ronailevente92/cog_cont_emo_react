...
model_A <-
  ...
  scale_y_discrete(
    labels = c(nback_dprime_centered = "2-back",
               ...
               event_unpleasantness_centered = "Event-\nunpleasantness",
...
# ggsave("main_plot_pdg.pdf", device = "pdf", width = 30, height = 20, units = "cm")
...
ggsave("emo_react.jpg", device = "jpg", width = 30, height = 20, units = "cm", )
