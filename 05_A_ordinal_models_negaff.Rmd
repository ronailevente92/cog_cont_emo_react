...
Adding age and sex because otherwise there is a severe convergence issue with a max\|gradient\~155.
...
```{r}
tab_model(
  mod_clmm_sad_gonogo, mod_clmm_sad_nback,
  mod_clmm_angry_gonogo, mod_clmm_angry_nback
   #, file = "tables/ordinal_models_negaff_control.html"
)
```
