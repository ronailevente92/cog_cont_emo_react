...
dat_cleaned <-
  ...
  select(id_esm, session_esm, age, gender, edu, city, start_date, date_esm, date_cogtask,
         ...
         contains(c("gonogo", "nback", "cerq_")), -contains(c("minutes")),
...
model_dat <- 
  ...
  select(id_esm, edu, gender, age, city, 
         ...
         contains(c("_mean_grand_centered")), trait_rumination,
...
model_dat %>%
  filter_at(vars(sad, angry, cheerful, calm, 
                 event_unpleasantness_centered,
                 nback_dprime_centered, trait_rumination), all_vars(!is.na(.))) %>%
  distinct() %>% 
...
model_dat %>%
  filter_at(vars(sad, angry, cheerful, calm, 
                 event_unpleasantness_centered,
                 gonogo_dprime_centered, trait_rumination), all_vars(!is.na(.))) %>%
  distinct() %>% 
